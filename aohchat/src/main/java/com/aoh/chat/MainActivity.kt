...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ElementTheme {
                ...
                Log.d("AOH Chat", "loggedInState $loggedInState")
    ...
    fun getOrRestore(sessionId: SessionId): Result<MatrixClient> {
        return runBlocking {
            when (val matrixClient = matrixAuthenticationService.restoreSession(sessionId).getOrNull()) {
    ...
    private suspend fun restore(sessionId: SessionId): Result<MatrixClient> {
        ...
        return matrixAuthenticationService.restoreSession(sessionId)
            .onSuccess { matrixClient ->
                Timber.e( "Success to restore session ${matrixClient.sessionId}")
